...
function setup() {
  ...
  red = createSprite(10,190,50,50);
  Red.addImage(red_balloonImage);
  
  blue = createSprite(10,150,20,20);
...
var blue = createSprite(0,Math.round(random(30,450)),10,10);
blue.addImage(blue_balloonImage);
blue.velocityX = 2;
blue.lifetime = 150;
blue.scale = 0.1;
...
function greenBalloon() {
 var green = createSprite(0,Math.round(ramdom()))  
